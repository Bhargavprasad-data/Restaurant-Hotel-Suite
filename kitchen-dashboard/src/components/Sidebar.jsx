...
import { ChefHat, Clock, LogOut, Flame } from 'lucide-react';

const LINKS = [
  { to: '/',           label: 'Kitchen Board', icon: ChefHat, end: true  },
  ...
  return (
    <>
      ...
      >
        ...
        >
          {/* Logo icon */}
          <div className="w-[28px] h-[28px] rounded-[8px] bg-gradient-to-br from-amber-500 to-orange-600 flex items-center justify-center shrink-0 shadow-lg shadow-amber-500/25">
          ...
          >
            ...
            <div className="text-[9px] font-semibold text-amber-400 uppercase tracking-[0.14em] mt-[3px]">Kitchen Panel</div>
          </div>
        </div>
            ...
            >
              {({ isActive }) => (
                <div className={`nav-item ${isActive ? 'active' : ''}`}>
                  <Icon
                    size={17}
                    className={`shrink-0 transition-transform duration-200 ${isActive ? 'text-amber-400' : ''}`}
                  />
                  <span
        ...
        <div className="p-2 space-y-0.5 overflow-hidden shrink-0">
          ...
          {user && (
            <div className="flex items-center gap-3 px-3 py-2 rounded-lg overflow-hidden">
              <div className="w-[28px] h-[28px] rounded-full bg-amber-500/20 border border-amber-500/30 flex items-center justify-center text-[11px] font-bold text-amber-400 shrink-0">
              ...
              >
                ...
                <span className="text-[9px] font-bold text-amber-500 uppercase tracking-[0.1em] mt-0.5">Chef</span>
              </div>
            </div>
          )}
          ...
          <button
            ...
            className="w-full nav-item text-slate-500 hover:!bg-rose-500/[0.1] hover:!text-rose-400 transition-all cursor-pointer"
          >
